...
activities = {
    ...
    "Drama Club": {
        "description": "Act, perform, and explore creative storytelling",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["charlotte@mergington.edu", "amelia@mergington.edu"]
    },
    "Art Studio": {
        "description": "Experiment with drawing, painting, and mixed media",
    ...
    "Science Olympiad": {
        "description": "Solve challenging science problems and compete academically",
